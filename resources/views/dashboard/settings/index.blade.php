...
@section('main')
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><strong>{{ __('dict.settings') }}</strong></li>
        ...
        <div class="container-fluid">
            ...
            <div class="animated fadeIn">
                <form action="{{ route('dashboard.settings.update', $settings) }}" method="post"
                            ...
                            <div class="card-block">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <img src="{{ asset($settings->logo) }}" alt="logo" width="50"
                                            class="d-block">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <img src="{{ asset($settings->favicon) }}" alt="favicon" width="25"
                                            class="d-block">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                        value="{{ $settings->email }}" placeholder="Enter email address">
                                    @if ($errors->has('email'))
                                        ...
                                        <div class="tab-pane fade @if ($loop->index == 0) show active in @endif"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="{{ $key }}[title]"
                                                    class="form-control" value="{{ $settings->translate($key)->title }}"
                                                    placeholder="Enter title">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="desc">{{ __('dict.desc') }}</label>
                                                <input type="text" name="{{ $key }}[desc]"
                                                    class="form-control" value="{{ $settings->translate($key)->desc }}"
