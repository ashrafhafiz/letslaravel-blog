...
@section('main')
    ...
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><strong>{{ __('dict.create_new_post') }}</strong></li>
        </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="font-2xl">{{ __('dict.create_new_post') }}</strong><span>
                                    {{ __('dict.form') }}</span>
                            </div>
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="parent_category_id">{{ __('dict.post_category') }}</label>
                                        <select name="parent_category_id" id="parent_category_id" class="form-control">
                                            <option value="">Select Post Category</option>
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}">
                                                    {{ $category->translate(app()->getLocale())->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                                ...
                                                <div class="tab-pane fade @if ($loop->index == 0) show active in @endif"
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea type="text" name="{{ $key }}[content]" class="form-control" value=""
