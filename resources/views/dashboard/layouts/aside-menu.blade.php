        ...
        <div class="tab-pane active" id="timeline" role="tabpanel">
            ...
            <div class="callout callout-warning m-a-0 p-y-1">
                <div class="avatar pull-xs-right">
                    <img src="{{ asset('assets/dashboard/img/avatars/7.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                </div>
                <div>Meeting with
                    <strong>Lucas</strong>
                </div>
            ...
            <div class="callout callout-primary m-a-0 p-y-1">
                ...
                <div class="avatars-stack m-t-h">
                    ...
                    <div class="avatar avatar-xs">
                        <img src="{{ asset('assets/dashboard/img/avatars/8.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                    </div>
                </div>
            </div>
            <hr class="m-x-1 m-y-0">
