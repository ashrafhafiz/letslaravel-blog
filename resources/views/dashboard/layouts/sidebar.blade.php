<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard.index') }}"><i class="icon-speedometer"></i> Dashboard <span
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard.settings') }}"><i class="icon-settings"></i>
                    {{ trans('dict.settings') }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard.categories.index') }}"><i class="icon-paper-clip"></i>
                    {{ trans('dict.categories') }}</a>
            </li>
            <li class="divider"></li>
            <li class="nav-title">
                Editor Area
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard.posts.index') }}"><i class="icon-pencil"></i>
                    {{ trans('dict.posts') }}</a>
            </li>
            {{-- <li class="nav-item">
